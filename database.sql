...
CREATE TABLE processos (
    ...
    distribuicao_data      DATE           NULL,
    redistribuicao         VARCHAR(150),
...
CREATE TABLE datas_controlo (
    ...
    acordao                 DATE      NULL,
    numero_acordao          VARCHAR(50) NULL,
    acordao2                DATE      NULL,
    numero_acordao2         VARCHAR(50) NULL,
    acordao3                DATE      NULL,
    numero_acordao3         VARCHAR(50) NULL,
    notificacao_acordao     DATE      NULL,
    notificacao_acordao2    DATE      NULL,
    notificacao_acordao3    DATE      NULL,
    conta_custas            DATE      NULL,
    conta_custas2           DATE      NULL,
    notificacao_conta_custas  DATE    NULL,
    notificacao_conta_custas2 DATE    NULL,
