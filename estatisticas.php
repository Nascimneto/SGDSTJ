...
// Lista de utilizadores para o filtro — não exige perfil Administrador (a
// própria api/estatisticas/distribuicao.php já devolve esta lista, agregada
// por utilizador, a qualquer perfil autenticado).
$pdo          = obterConexao();
$utilizadores = $pdo->query('SELECT id, nome_completo FROM utilizadores ORDER BY nome_completo')->fetchAll();
?>
<!DOCTYPE html>
<html lang="pt">
<head>
