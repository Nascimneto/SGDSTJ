-- ══════════════════════════════════════════════════════════════
-- Migração — 2026-07-11
-- Adiciona a data de Redistribuição às Datas de Controlo Processual
-- (datas_controlo.redistribuicao_data) — distinta de
-- processos.redistribuicao, que guarda apenas o nome do novo
-- magistrado.
--
...
ALTER TABLE datas_controlo
    ADD COLUMN IF NOT EXISTS redistribuicao_data DATE NULL AFTER processo_id;
