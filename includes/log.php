 ...
 * Lido depois por api/auditoria/sistema.php. Ver database.sql, tabela
 * auditoria_sistema, e a distinção com historico_processo.
 */
function sgd_registar_auditoria(PDO $pdo, string $tipoEvento, string $codigoEvento, string $mensagem): void
{
    $pdo->prepare(
